...
CRITICAL: Focus on STATE-OF-THE-ART (2025-2026) research. When searching literature, ALWAYS include year keywords like "2025" or "2026" in your queries. Search for papers from top venues (NeurIPS, ICML, ICLR, CVPR, USENIX, IEEE S&P, CCS, NDSS). The proposals must be cutting-edge and address open problems that are actively researched TODAY. Avoid proposing ideas that were solved before 2024.
...
Note: You should perform at least TWO literature searches with different SOTA-focused queries (e.g., "Android malware detection 2025", "adversarial android security 2026") before finalizing your idea to ensure it is well-informed by existing research and addresses truly open problems."""
